                    ...
                    <div class="margin-top-xs text-sm">
                        <div class="flex gap-xxs items-center">
                            ...
                            @if($disable_comments != 'on')
                                ...
                                <div data-reply-id="{{$comment->comment_id}}" data-post-id="{{$post_id}}" role="button" class="comments__label-btn js-tab-focus comment-reply">Reply</div>
                            @endif
                    ...
                    <div class="comments__content margin-top-xxxs">
                        ...
                        <div class="margin-top-xs text-sm">
                            <div class="flex gap-xxs items-center">
                                ...
                                <span class="comments__inline-divider" aria-hidden="true"></span>
                                <a href="{{url('post/comment/reply/'.$comment->comment_id)}}" data-save-url="{{url('post/comment/reply-save/'.$comment->comment_id)}}" aria-controls="modal-comment-reply-{{$post_id}}" data-post-id="{{$post_id}}" role="button" class="reset comments__label-btn js-tab-focus comment-reply">Reply</a>
