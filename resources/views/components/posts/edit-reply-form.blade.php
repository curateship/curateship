<div class="alert js-alert margin-bottom-lg" role="alert"> <!-- /.alert--is-visible -->
    ...
    <div class="margin-top-md">
      <div class="margin-bottom-md">
        <h3 class="margin-bottom-sm">Comment</h3>
        <p class="margin-top-md">{!! $comment->comment !!}</p>
      </div>
      <h3 class="margin-top-md">Description</h3>
      <textarea class="form-control width-100% margin-top-sm" type="text" name="comment" id="comment" cols="10" rows="15" @error('comment') aria-invalid="true" @enderror></textarea>
