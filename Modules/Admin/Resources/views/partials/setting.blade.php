                            ...
                            <div class="subnav__wrapper toc toc--static@md position-sticky@md js-toc js-subnav__wrapper">
                                <nav class="justify-left">
                                    <ul class="subnav__list toc__list js-toc__list">
                                        ...
                                        <li class="subnav__item toc__link"><a href="#cache-tools" class="subnav__link js-smooth-scroll" data-duration="300">Cache</a></li>
                                        <li class="subnav__item toc__link"><a href="#webp-conversion" class="subnav__link js-smooth-scroll" data-duration="300">Webp Convertion</a></li>
                                    </ul>
                                </nav>
                            </div>
                            ...
                            <fieldset class="margin-bottom-md margin-top-md">
                                ...
                                <div id="template-setting">
                                    ...
                                    <div class="form-control-section margin-bottom-md">
                                        ...
                                        <div class="choice-btns choice-inline gap-xxs js-choice-btns margin-top-md">
                                            @foreach($search_templates as $template)
                                                <div class="choice-btn padding-sm js-choice-btn">
                                                    <!-- fallback -->
                                                    <div class="choice-btn__fallback">
                                                        <input type="radio" name="search_template" id="search_template_{{$template['name']}}" value="{{$template['name']}}" {{$template['checked']}}>
                                                        <label for="choice-radio-button-1">{{$template['name']}}</label>
                                                    </div>
                                ...
                                <h1 class="margin-bottom-xs">Dark Mode</h1>
                                <div class="margin-bottom-md">
                                    <ul class="radio-switch ">
                                        <li class="radio-switch__item">
                                            <input class="radio-switch__input sr-only" type="radio" name="theme" value="white" id="radio-1" {{!empty($settings_data['theme']) && $settings_data['theme'] == 'white' ? 'checked' : ''}}>
                                        ...
                                        <li class="radio-switch__item">
                                            <input class="radio-switch__input sr-only" type="radio" name="theme" value="dark" id="radio-2" {{!empty($settings_data['theme']) && $settings_data['theme'] == 'dark' ? 'checked' : ''}}>
                                ...
                                <div id="cache-tools">
                                    <div class="form-control-section">
                                        <h1 class="margin-bottom-xs">Cache tools</h1>
                                        <div class="alert alert-sub js-alert margin-bottom-lg" role="alert">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center">
                                                    <svg aria-hidden="true" class="icon margin-right-xxxs" viewBox="0 0 32 32" ><title>info icon</title><g><path d="M16,0C7.178,0,0,7.178,0,16s7.178,16,16,16s16-7.178,16-16S24.822,0,16,0z M18,7c1.105,0,2,0.895,2,2 s-0.895,2-2,2s-2-0.895-2-2S16.895,7,18,7z M19.763,24.046C17.944,24.762,17.413,25,16.245,25c-0.954,0-1.696-0.233-2.225-0.698 c-1.045-0.92-0.869-2.248-0.542-3.608l0.984-3.483c0.19-0.717,0.575-2.182,0.036-2.696c-0.539-0.514-1.794-0.189-2.524,0.083 l0.263-1.073c1.054-0.429,2.386-0.954,3.523-0.954c1.71,0,2.961,0.855,2.961,2.469c0,0.151-0.018,0.417-0.053,0.799 c-0.066,0.701-0.086,0.655-1.178,4.521c-0.122,0.425-0.311,1.328-0.311,1.765c0,1.683,1.957,1.267,2.847,0.847L19.763,24.046z"></path></g></svg>
                                        ...
                                        <div class="margin-bottom-md margin-top-md">
                                            <div class="grid gap-xxs items-center@md">
                                                ...
                                                <div class="col-8@md">
                                                    <ul class="flex flex-wrap gap-md">
                                                        <li>
                                                            <input class="checkbox" type="checkbox" name="disable_cache" id="disableCache" {{$settings_data['disable_cache'] === 'on' ? 'checked' : ''}}>
                                                            <label for="disableCache">Disable cache</label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div id="webp-conversion">
                                    <div class="form-control-section">
                                        <h1 class="margin-bottom-xs">Webp conversion</h1>
                                        <div class="alert alert-sub js-alert margin-bottom-lg" role="alert">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center">
                                                    <svg aria-hidden="true" class="icon margin-right-xxxs" viewBox="0 0 32 32" ><title>info icon</title><g><path d="M16,0C7.178,0,0,7.178,0,16s7.178,16,16,16s16-7.178,16-16S24.822,0,16,0z M18,7c1.105,0,2,0.895,2,2 s-0.895,2-2,2s-2-0.895-2-2S16.895,7,18,7z M19.763,24.046C17.944,24.762,17.413,25,16.245,25c-0.954,0-1.696-0.233-2.225-0.698 c-1.045-0.92-0.869-2.248-0.542-3.608l0.984-3.483c0.19-0.717,0.575-2.182,0.036-2.696c-0.539-0.514-1.794-0.189-2.524,0.083 l0.263-1.073c1.054-0.429,2.386-0.954,3.523-0.954c1.71,0,2.961,0.855,2.961,2.469c0,0.151-0.018,0.417-0.053,0.799 c-0.066,0.701-0.086,0.655-1.178,4.521c-0.122,0.425-0.311,1.328-0.311,1.765c0,1.683,1.957,1.267,2.847,0.847L19.763,24.046z"></path></g></svg>
                                        ...
                                        <div class="margin-bottom-md margin-top-md">
                                            <div class="grid gap-xxs items-center@md">
                                                ...
                                                <div class="col-8@md">
                                                    <ul class="flex flex-wrap gap-md">
                                                        <li>
                                                            <input class="checkbox" type="checkbox" name="webp_conversion" id="webpConversion" {{$settings_data['webp_conversion'] === 'on' ? 'checked' : ''}}>
                                                            <label for="webpConversion">Enable conversion</label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
