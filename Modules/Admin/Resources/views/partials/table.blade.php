...
<div class="col-12@md radius-md shadow-md bg-contrast-lower">
<div class="int-table-actions" data-table-controls="table-1">
            ...
            <!-- Control Bar -->
              <div class="flex justify-between">
                <div class="margin-xs">
                  <div class="inline-flex items-baseline">
                    <h1 class="text-md margin-x-xs" for="filterItems">Posts</h1>
                  </div>
                </div>
                <!-- END Control Bar-->
                <div class="margin-top-auto border-top border-contrast-high"></div><!-- Divider -->
                <!-- Menu Bar -->
              ...
              <!-- END Control Bar-->
              <div class="margin-top-auto border-top border-contrast-lowest padding-bottom-xs"></div><!-- Divider -->
              <div class="int-table-actions" data-table-controls="table-1">
          
</div>

<div id="table-1 padding-sm" class="int-table text-sm js-int-table">
  <div class="int-table__inner padding-sm">
