    ...
    <div class="header-v2__container container max-width-lg">
      ...
      <nav id="main-menu" class="header-v2__nav color-contrast-low header-v2__nav-full-height margin-left-xxl@md" role="navigation">
        <ul class="header-v2__nav-list header-v2__nav-list--main">
          ...
          <li class="header-v2__nav-item header-v2__nav-item--main"><a href="{{ url('admin/editor') }}" class="header-v2__nav-link"
              {{ Request::path() == 'admin/editor' ? 'aria-current' : '' }}><span>Editor</span></a></li>
      </nav>
