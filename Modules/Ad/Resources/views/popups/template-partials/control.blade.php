<div class="controlbar--sticky flex justify-between">
  <div class="margin-xs">
    <div class="inline-flex items-baseline">
      <h1 class="text-md color-contrast-high padding-y-xxxxs margin-x-xs" for="filterItems">Templates:</h1>
  ...
  <div class="flex flex-wrap items-center justify-between margin-right-xxs">
    ...
    <li class="menu-bar__item js-menu-bar" aria-controls="add-modal">
      <svg class="icon menu-bar__icon" aria-hidden="true" viewBox="0 0 20 20">
        ...
        <span class="menu-bar__label">Add Template</span>
      </li>

      <li class="menu-bar__item">
        <a href="{{ url('admin/ad/popups') }}">
        ...
        <span class="menu-bar__label">Add Popups</span>
      </li>
