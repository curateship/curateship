<div class="modal modal--animate-scale flex flex-center bg-black bg-opacity-90% padding-md js-modal" id="create-modal">
  <div class="modal__content width-100% max-width-xs max-height-100% overflow-auto bg radius-md inner-glow shadow-md" role="alertdialog" aria-labelledby="modal-title-1" aria-describedby="modal-description-1">
    <header class="bg-contrast-lower bg-opacity-50% padding-y-sm padding-x-md flex items-center justify-between">
      <h4 class="text-truncate" id="modal-title-1">Create Template</h4>
 ...
 <div class="padding-md">
  ...
  <fieldset class="margin-bottom-md">
    ...
    <div class="grid gap-sm">
        <label class="form-label margin-bottom-xxs" for="input-name">Template name</label>
        <input class="form-control width-100%" type="text" name="input-name" id="input-name" required>

        <label class="form-label margin-bottom-xxs" for="input-name">URL Slug</label>
        <input class="form-control width-100%" type="text" name="input-name" id="input-name" required>

        <label class="form-label margin-bottom-xxs" for="input-name">Page Title</label>
        <input class="form-control width-100%" type="text" name="input-name" id="input-name" required>

        <label class="form-label margin-bottom-xxs" for="input-name">Meta Discription</label>
        <input class="form-control width-100%" type="text" name="input-name" id="input-name" required>
