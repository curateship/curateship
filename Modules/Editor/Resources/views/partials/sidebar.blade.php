<div class="col-3@md margin-top-sm">
<nav class="tree js-tree">
  <ul class="tree__nodes">
    <li class="tree__node tree__node--expanded">
      <button class="reset tree__item js-tree__node-control">
        ...
        <span class="tree__label">Core</span>
      </button>

      <ul class="tree__nodes">

        <li class="tree__node">
          <a class="tree__item" href="#0">
            ...
            <span class="tree__label">Search</span>
          </a>
        </li>
        ...
        <li class="tree__node">
          <a class="tree__item" href="#0">
            ...
            <span class="tree__label">Tags</span>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="tree__node tree__node--expanded">
      <button class="reset tree__item js-tree__node-control">
        ...
        <span class="tree__label">Templates</span>
      </button>
      ...
      <ul class="tree__nodes">
        ...
        <li class="tree__node">
          <a class="tree__item" href="#0">
            ...
            <span class="tree__label">Name1</span>
          </a>
        </li>
  </ul>
  ...
  <li class="tree__node tree__node--expanded">
      <button class="reset tree__item js-tree__node-control">
        ...
        <span class="tree__label">Apps</span>
      </button>
