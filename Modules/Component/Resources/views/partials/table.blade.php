<div class="tabs-v3 js-tabs">
  <ul class="tabs-v3__controls js-tabs__controls text-component text-sm border-bottom border-contrast-low" aria-label="Tabs Interface">
    ...
    <li><a href="#tab1Panel3" class="tabs-v3__control js-tab-focus">Controller</a></li>
    <li><a href="#tab1Panel3" class="tabs-v3__control js-tab-focus">Setting</a></li>
  </ul>
